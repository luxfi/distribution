...
export interface LUXTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LUXToken extends BaseContract {
  connect(runner?: ContractRunner | null): LUXToken;
  waitForDeployment(): Promise<this>;

  interface: LUXTokenInterface;
