...
export interface UniswapV3PoolMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "observeSingle",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export interface UniswapV3PoolMock extends BaseContract {
  ...
  observeSingle: TypedContractMethod<
    [
      arg0: BigNumberish,
      arg1: BigNumberish,
      arg2: BigNumberish,
  ...
  protocolFees: TypedContractMethod<
    [],
    [[bigint, bigint] & { token0Fees: bigint; token1Fees: bigint }],
    "view"
  >;
  ...
  slot0: TypedContractMethod<
    ...
    [
      [bigint, bigint, bigint, bigint, bigint, bigint, boolean] & {
        ...
        tick_: bigint;
        observationIndex_: bigint;
        observationCardinality_: bigint;
        observationCardinalityNext_: bigint;
        feeProtocol_: bigint;
        unlocked_: boolean;
      }
    ],
  ...
  ): TypedContractMethod<[sqrtPriceX96_: BigNumberish], [void], "nonpayable">;
  getFunction(
